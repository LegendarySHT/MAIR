...
// CHECK_0_BYTES: ERROR: {{AddressSanitizer|XSan}}: global-buffer-overflow on address [[ADDR:.*]] at
// CHECK_0_BYTES: [[ADDR]] is located 0 bytes after

// CHECK_1_BYTES: ERROR: {{AddressSanitizer|XSan}}: global-buffer-overflow on address [[ADDR:.*]] at
