 ...
 *
 * 3) Phase — Loop（runAsanMopIRLoopRelocationPhase）：通过 LLVM::LLVMPassManager
 *    调度 LoopInvariantRelocationLLVMWrapperPass，对 LLVM IR 做 MopIR
 *    循环不变量外提（MAIR_USE_MOPIR_ASAN_LOOP_RELOC）。放在冗余之后，
