...
function(get_triple arch variable)
  string(FIND ${XSAN_DEFAULT_TARGET_TRIPLE} "-" dash_index)
  string(SUBSTRING ${XSAN_DEFAULT_TARGET_TRIPLE} ${dash_index} -1 triple_suffix)
  string(SUBSTRING ${XSAN_DEFAULT_TARGET_TRIPLE} 0 ${dash_index} triple_cpu)
  if(COMPILER_RT_DEFAULT_TARGET_ONLY)
    # Use exact spelling when building only for the target specified to CMake.
    set(target "${XSAN_DEFAULT_TARGET_TRIPLE}")
