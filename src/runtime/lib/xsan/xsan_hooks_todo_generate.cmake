# generate xsan_hooks_todo.h automatically
...
set(XSAN_HOOKS_HEADER "${CMAKE_CURRENT_SOURCE_DIR}/xsan_hooks_todo.h") 
if(EXISTS "${XSAN_HOOKS_HEADER}")
  file(REMOVE "${XSAN_HOOKS_HEADER}")
endif()

set(XSAN_HOOKS_CONTENT "/// Auto-generated by CMake
#pragma once
